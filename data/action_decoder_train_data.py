"""
action dataloader to train the model
"""
import numpy as np
import os
...
class ActionDecoderBehaveDataset(BaseDataset):
    def __init__(self, data_paths, batch_size, phase,
        ...
        super(ActionDecoderBehaveDataset, self).__init__(data_paths, batch_size, num_workers, dtype, aug_blur)
        self.phase = phase
    ...
    def get_item(self, idx):
        ...
        res['action'] = action.astype(np.uint8)
